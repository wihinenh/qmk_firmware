...
#include QMK_KEYBOARD_H
    ...
    /* Symbol layer */
      [1] = LAYOUT(
        ...
        KC_TRNS,   KC_CIRC, KC_MINS, KC_EQL,  KC_DLR,  KC_EXLM, KC_TRNS, KC_GRV,  KC_COLN, KC_QUOT, KC_DQUO, KC_SCLN, KC_BSLS,   KC_TRNS, KC_END,
        KC_TRNS,   KC_TRNS, KC_UNDS, KC_PLUS, KC_TILD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LT,   KC_GT,   KC_TRNS, KC_MUTE,   KC_VOLU,
