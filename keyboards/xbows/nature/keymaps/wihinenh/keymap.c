...
#include QMK_KEYBOARD_H
    ...
    /* Symbol layer */
      [1] = LAYOUT(
        ...
        KC_TRNS,   KC_HASH, KC_AMPR, KC_PERC, KC_ASTR, KC_TRNS,          KC_TRNS, KC_LBRC, KC_LCBR, KC_RCBR, KC_RBRC, KC_TRNS,   KC_TRNS, KC_TRNS, KC_HOME,
        KC_TRNS,   KC_CIRC, KC_MINS, KC_EQL,  KC_DLR,  KC_PIPE, KC_TRNS, KC_GRV,  KC_COLN, KC_QUOT, KC_DQUO, KC_SCLN, KC_TRNS,   KC_TRNS, KC_END,
        KC_TRNS,   KC_AT,   KC_UNDS, KC_PLUS, KC_TILD, KC_TRNS, KC_TRNS, KC_BSLS, KC_EXLM, KC_LT,   KC_GT,   KC_QUES, KC_MUTE,   KC_VOLU,
